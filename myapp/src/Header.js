...
export default class Header extends Component {
  ...
  <header className="main-header">
    ...
    <a href="index2.html" className="logo">
      ...
      <span className="logo-mini"><b>Tutor</b></span>
      {/* logo for regular state and mobile devices */}
      <span className="logo-lg"><b>Tutor</b>Dashboard</span>
    </a>
        ...
        <ul className="nav navbar-nav">
          ...
          <li className="dropdown user user-menu">
            <a href="fake_url" className="dropdown-toggle" data-toggle="dropdown">
              ...
              <span className="hidden-xs">Admin admin</span>
            </a>
            <ul className="dropdown-menu">
              {/* User image */}
              <li className="user-header">
                ...
                <p>
                  Admin admin - Software Developer
